...
- Colors for status/semantic red-green in anything I build (dashboards, artifacts, plots): reuse this colorblind-safe palette rather than inventing a new red/green pair. Green #1baf7a (light) / #199e70 (dark), red #b0413e / #c9524f, blue #2a78d6 / #3987e5, orange #eb6834 / #d95926. If `$PALETTE_CSS` is set, prefer the palette defined there.
